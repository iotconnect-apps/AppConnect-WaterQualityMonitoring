...
namespace component.eventbus
{
    ...
    public class AzureQueueSender : QueueClient, IEventBus
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureQueueSender"/> class.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        /// <param name="queueName">Name of the queue.</param>
        public AzureQueueSender(string connectionString, string queueName) : base(connectionString, queueName, ReceiveMode.PeekLock, new RetryExponential(TimeSpan.FromSeconds(0), TimeSpan.FromSeconds(3), 3))
        {
        }
