...
namespace component.eventbus
{
    ...
    /// AzureTopicPublisher
    /// </summary>
    /// <seealso cref="Microsoft.Azure.ServiceBus.TopicClient" />
    /// <seealso cref="component.eventbus.IEventBus" />
    public class AzureTopicPublisher : TopicClient, IEventBus
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureTopicPublisher"/> class.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        /// <param name="topicName">Name of the topic.</param>
        public AzureTopicPublisher(string connectionString, string topicName) : base(connectionString, topicName, new RetryExponential(TimeSpan.FromSeconds(0), TimeSpan.FromSeconds(3), 3))
        {
        }
